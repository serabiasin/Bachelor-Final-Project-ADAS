...
def SSD300(img_size, n_classes, l2_reg=5e-4,
    ...
    block2 = depthwise_conv(block1, 128, alpha=1,
                            strides=(2, 2), name='block2')
    block3 = depthwise_conv(block2, 128, alpha=1, name='block3')

    block4 = depthwise_conv(block3, 256, alpha=1,
                            strides=(2, 2), name='block4')
    block5 = depthwise_conv(block4, 256, alpha=1, name='block5')

    block6 = depthwise_conv(block5, 512, alpha=1,
                            strides=(2, 2), name='block6')
    ...
    block12 = depthwise_conv(block11, 1024, alpha=1,
                             strides=(2, 2), name='block12')
    ...
    fc7_mbox_conf = Conv2D(
        n_boxes[1] * classes, (3, 3), padding='same', name='fc7_mbox_conf')(block13)
    ...
    fc7_mbox_loc = Conv2D(n_boxes[1] * 4, (3, 3),
                          padding='same', name='fc7_mbox_loc')(block13)
