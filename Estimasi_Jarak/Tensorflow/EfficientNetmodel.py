...
class Encoder(Model):
    def __init__(self):
        ...
        self.base_model = EfficientNetB0(input_shape=(
        ...
        #New
        upsample_layer = ['block5c_se_excite',
                          'block3b_se_excite', 'block2b_se_excite', 'stem_conv']
...
class Decoder(Model):
    ...
    def call(self, features):
        ...
        up0 = self.conv2(x)
        up1 = self.up1([up0, pool1])
        up2 = self.up2([up1, pool2])
        up3 = self.up3([up2, pool3])
