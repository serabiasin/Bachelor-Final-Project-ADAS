...
def SSD300(img_size, n_classes, l2_reg=5e-4,
            anchors=[50, 80, 131, 162, 213, 264, 315],
    ...
    conv4_3_norm = Normalize(classes-1, name='conv4_3_norm')(block11)
    ...
    fc7_mbox_loc = Conv2D(n_boxes[1] * 4, (1, 1), padding='same', name='fc7_mbox_loc')(block13)
    conv6_2_mbox_loc = Conv2D(n_boxes[2] * 4, (1, 1), padding='same', name='conv6_2_mbox_loc')(conv6_2)
    conv7_2_mbox_loc = Conv2D(n_boxes[3] * 4, (1, 1), padding='same',  name='conv7_2_mbox_loc')(conv7_2)
    conv8_2_mbox_loc = Conv2D(n_boxes[4] * 4, (1, 1), padding='same', name='conv8_2_mbox_loc')(conv8_2)
    conv9_2_mbox_loc = Conv2D(n_boxes[5] * 4, (1, 1), padding='same', name='conv9_2_mbox_loc')(conv9_2)
    
    #Ambil ciri dari block11
