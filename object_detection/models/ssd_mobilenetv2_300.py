...
def SSD300(img_size, n_classes, l2_reg=5e-4,
    ...
    conv6_2 = ssd_convolution(conv6_1,  512, (3, 3), strides=(
        2, 2), padding='same', name='conv6_2')

    conv7_1 = ssd_convolution(conv6_2, 128, (1, 1),
                              padding='same', name='conv7_1')
    conv7_2 = ssd_convolution(conv7_1, 256, (3, 3), strides=(
        2, 2), padding='same', name='conv7_2')

    conv8_1 = ssd_convolution(conv7_2, 128, (1, 1),
                              padding='same', name='conv8_1')
    conv8_2 = ssd_convolution(conv8_1, 256, (3, 3), strides=(
        2, 2), padding='same', name='conv8_2')

    conv9_1 = ssd_convolution(conv8_2, 128, (1, 1),
                              padding='same', name='conv9_1')
    conv9_2 = ssd_convolution(conv9_1, 256, (3, 3), strides=(
    ...
    fc7_mbox_conf = Conv2D(n_boxes[1] * classes, (3, 3), padding='same',
                           name='fc7_mbox_conf')(base_network.get_layer("block_16_depthwise").output)
    ...
    fc7_mbox_loc = Conv2D(n_boxes[1] * 4, (3, 3), padding='same', name='fc7_mbox_loc')(
        base_network.get_layer("block_16_depthwise").output)
    ...
    fc7_mbox_priorbox = AnchorBoxes(img_size=img_size, min_size=anchors[1], max_size=anchors[2], aspect_ratios=[2, 3],
                                    variances=variances, name='fc7_mbox_priorbox')(base_network.get_layer("block_16_depthwise").output)
